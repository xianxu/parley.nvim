...
describe('native captured subprocess authority',function()
    ...
    it('searches with broad optional globs and hidden files',function()
    ...
    it('searches every captured root with a glob',function()
