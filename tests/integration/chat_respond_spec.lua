...
💬: What is Lua?
    ...
    it("shows a waiting third leg outside folds after two recursive tool rounds", function()
        ...
        local transcript = table.concat(vim.api.nvim_buf_get_lines(buf, 0, -1, false), "\n")
        local _, occurrence_count = transcript:gsub("final answer", "")
        assert.equals(1, occurrence_count, "staged answer must flush exactly once")
