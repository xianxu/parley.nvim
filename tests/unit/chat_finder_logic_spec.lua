...
describe("ChatFinder logic", function()
    ...
    describe("Group F: Chat finder picker mappings", function()
        ...
        it("keeps recency outside the exact discovery fingerprint", function()
            ...
            assert.equals("YYYY-MM-DD*.md|welcome.md|basics.md|advanced.md", first_data.pattern)
        ...
        it("opens with the active recency label and all four cycle mappings", function()
            ...
            assert.same({ "<C-x>" }, captured.mappings[3].key)
            assert.same({ "<C-a>" }, captured.mappings[4].key)
            assert.same({ "<Tab>" }, captured.mappings[5].key)
            assert.same({ "<C-s>" }, captured.mappings[6].key)
            assert.same({ "<S-Tab>" }, captured.mappings[7].key)
        end)
