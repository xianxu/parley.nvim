...
M.open = function(_)
	...
	local delete_shortcut = kb.keys_for("nf_delete", cfg)
	local next_recency_shortcut = kb.keys_for("nf_next_recency", cfg)
	local previous_recency_shortcut = kb.keys_for("nf_prev_recency", cfg)
