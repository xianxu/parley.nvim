...
M.chat_system_prompt = "A conversation between You and Me. \n\n"
    ...
    .. "After 📝:, summarize this whole response for text-to-speech. No markdown, no tables, no code, no links. This summary should retain key structural points, to help user glanced through the response. Keep this within 42 words. Prefix each of such text-to-speech ready lines with 👂: \n\n"
