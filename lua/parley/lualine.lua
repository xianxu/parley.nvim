  ...
  return {
    function()
      ...
      if is_busy then
        ...
        local current_agent_info = parley.get_agent_info and parley.get_agent_info({}, parley.get_agent(agent_name))
        if current_agent_info then
          local metrics_config = prov.get_cache_metrics_config(current_agent_info.provider)
