...
M.entries = {
	...
	{
		-- #160: smart `gf` — resolve an artifact ref under the cursor, else fall
		-- back to Vim's native gf. Transparent (native go-to-file preserved), so
		-- shadowing gf is safe. Set config.chat_shortcut_resolve_ref_gf = false-y
		-- (or remap) to disable.
		id = "resolve_ref_gf",
	...
	},
	{
		...
		scope = "parley_buffer",
		desc = "Parley insert 🤖 marker: wrap selection (v/x) / insert bare 🤖[] (i, n)",
	...
	},
	{
		...
		default_modes = { "n" },
		scope = "parley_buffer",
		desc = "Parley accept 🤖 marker at cursor per review-convention §5",
		help_desc = "Accept review marker",
		buffer_local = true,
	},
	{
		...
		default_modes = { "n" },
		scope = "parley_buffer",
		desc = "Parley reject 🤖 marker at cursor per review-convention §5",
		help_desc = "Reject review marker",
		buffer_local = true,
	},
	...
	{
		id = "cf_cycle_filter",
		config_key = "chat_finder_mappings.cycle_filter",
		default_key = "<Tab>",
		default_modes = { "n", "i", "v", "x" },
		scope = "chat_finder",
		desc = "Cycle recency window left",
	...
	{
		id = "cf_cycle_filter_prev",
		config_key = "chat_finder_mappings.cycle_filter_prev",
		default_key = "<S-Tab>",
		default_modes = { "n", "i", "v", "x" },
		scope = "chat_finder",
		desc = "Cycle recency window right",
