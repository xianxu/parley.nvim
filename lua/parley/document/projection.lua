...
function M.summary(metadata)
    ...
    return {
        ...
        completion_blocker=sem.exchange_start or sem.preface or sem.draft_start or false,
        completion_content=not token.blank and not sem.footer and not sem.content_ended,
        completion_suffix=not token.blank and not sem.annotation and not sem.footer and not sem.content_ended,
